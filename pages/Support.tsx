...
const FAQS = [
  ...
  { q: 'هل الشهادات معتمدة؟', a: 'نعم، جميع الشهادات التي تحصل عليها بعد إتمام الدورات معتمدة من منصة مُلَقّن ويمكن إضافتها إلى ملفك المهني أو LinkedIn.' },
  { q: 'ما هي طرق الدفع المتاحة؟', a: 'نقبل جميع البطاقات الائتمانية (Visa, MasterCard)، مدى، وApple Pay لضمان سهولة الدفع.' },
  { q: 'هل أحتاج لخبرة سابقة في البرمجة؟', a: 'لدينا مسارات مخصصة للمبتدئين تبدأ من الصفر، فلا تقلق إذا لم تكن لديك خبرة سابقة. نوفر شروحات مبسطة تناسب الجميع.' },
  { q: 'هل يعمل المحاكي على الجوال؟', a: 'نعم، المحاكي مصمم ليكون متجاوباً مع جميع الأجهزة اللوحية والهواتف، ولكن نوصي باستخدام الكمبيوتر للحصول على أفضل تجربة برمجية.' },
  { q: 'كيف يمكنني استرجاع مبلغ الدورة؟', a: 'نقدم ضمان استرجاع الأموال خلال 14 يوماً من الشراء إذا لم تكن راضياً عن المحتوى، بشرط عدم إكمال أكثر من 30% من الدورة.' },
];
          ...
          <div className="space-y-4">
            {FAQS.map((faq, idx) => (
              <div key={idx} className="bg-secondary rounded-lg border border-white/10 overflow-hidden">
                ...
                {openFaq === idx && (
                  <div className="p-4 text-gray-400 border-t border-white/5 bg-primary/50 text-sm leading-relaxed">
                    {faq.a}
                  </div>
                )}
              </div>
